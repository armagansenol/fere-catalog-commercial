  ...
  return (
    <>
      <section className={cn(s.about, "flex flex-col items-center py-8 tablet:py-16 line leading-none")}>
        <h1 className="text-30 tablet:text-40 font-normal font-albert-sans text-center leading-tight tablet:leading-snug max-w-prose mb-7 tablet:mb-14 px-4 tablet:px-40">
          Fere Catalog olarak, 2001 yılından bu yana toptan satış sektöründe faaliyet gösteren deneyimli bir ekibiz.
        </h1>
        <p className="text-20 tablet:text-30 font-light font-mukta text-center leading-snug max-w-prose mb-7 tablet:mb-24 px-4">
        ...
        <div className="px-4 tablet:px-[var(--spacing-lg)] w-full mb-7 tablet:mb-24">
          <div className="rounded-lg overflow-hidden h-img-md tablet:h-auto">
            <Img className="object-cover object-center" src={ipad} alt="Sample" />
          </div>
        </div>
        ...
        <p className="text-20 tablet:text-24 font-light font-mukta text-center leading-snug max-w-prose mb-5 tablet:mb-5 px-4">
          Fere Catalog ile, online ürün kataloglarını oluşturabilir, ürünlerini kendi belirledikleri kategoriler altında
          sergileyebilir ve çeşitli özellikler tanımlayabilirsiniz.
        </p>
        <p className="text-20 tablet:text-24 font-light font-mukta text-center leading-snug max-w-prose mb-14 tablet:mb-20 px-4">
          Müşterilerinize sadece mağazanızın linkini ileterek, ürünlerinizi incelemelerini ve sipariş oluşturmalarını
          sağlayabilirsiniz. Ayrıca, gerçek zamanlı raporlar sayesinde ürün performansınızı ve sipariş trendlerinizi
          kolayca takip edebilirsiniz.
        </p>
        <h2 className="text-40 tablet:text-45 font-normal font-albert-sans text-center leading-tighter tablet:leading-snug mb-10 tablet:mb-16 px-4">
        ...
        <div className="flex flex-col items-center tablet:grid grid-cols-2 tablet:items-start justify-items-stretch gap-x-16 tablet:gap-x-24 gap-y-14 tablet:gap-y-28 max-w-screen-lg px-4">
          <div className="flex flex-col items-center space-y-5">
            ...
            <p className="text-18 tablet:text-20 font-light font-albert-sans text-center leading-normal max-w-prose">
