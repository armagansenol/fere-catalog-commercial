...
export default async function Page({ searchParams }: { searchParams: { selectedPlan: string } }) {
  ...
  return (
    <div
      className={cx(
        s.register,
        "flex flex-col-reverse items-center tablet:items-start tablet:grid grid-cols-12 gap-8 px-4 tablet:px-[var(--spacing-lg)] pb-20"
      )}
    >
      ...
      <div className="col-span-4">
        <div className="space-y-3">
          <Card className="w-full max-w-sm mx-auto bg-[var(--lynx-white)] rounded-2xl tablet:rounded-3xl">
